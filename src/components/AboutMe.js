      ...
      <div className="container">
        <div className="row mb-5 align-items-center">
          ...
          <div className="col-lg-5 pl-lg-5">
            ...
            <p className="lead">I am currently working remotely as a technical support engineer for Microverse, where I review code and provide technical guidance for web development students in HTML & CSS and Ruby. I love to watch animation movies and coffee drinker.</p>
